...
<head>
    ...
    <style>
        ...
        .box{background:rgba(0,0,0,0.4); width: 95%; height:auto; margin:0px auto; color:white; border-radius: 10px;}
        .Judul{
            background:rgba(0,0,0,0.3); width: 50%; height:auto; left:0;
        ...
        .card{background-color: rgba(14, 38, 74, 0.429);}

    </style>
</head>
<body background={{ asset('img/alam.jpeg') }}>
    ...
    <div class="Judul fw-bold fs-3">Wisata Untukmu</div> <div class="spasi"></div>
        ...
        <div class="row ms-auto">
          @foreach($wisata as $wisatas)
            <div class="col-md-3 col-sm-4 col-lg-4 mb-4">
                <div class="card">
                    <a href="{{route('wisatadetail',[$wisatas->id])}}" style="text-align: center;"><img src={{ asset('img/luwengsampang.jpg') }} class="formatgambar card-img-top"></a>
                    <a href="{{route('wisatadetail',[$wisatas->id])}}" class="text-decoration-none">
                    <div class="card-body pt-2 text-light">
                        <div class="card-title"><h4>{{$wisatas->nama}}</h4></div>
                        {{$wisatas->alamat}}
                    </div></a>
                </div>
            </div>
