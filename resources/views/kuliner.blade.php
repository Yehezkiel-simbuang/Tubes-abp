...
<head>
    ...
    <style>
        ...
        .box{background:rgba(0, 0, 0, 0.5); width: 95%; height:auto; margin:0px auto; color:white; border-radius: 10px;}
        .Judul{
            background:rgba(255, 255, 255, 0.2); width: 50%; height:auto; left:0;
        ...
        .btnlg{
            border-radius: 10px; letter-spacing: 1px; font-weight: bold;
            font-size: 100%; width: fit-content; border: none;
            background-color: rgba(255, 255, 255, 0.4); color:white;
            box-shadow: -2px 2px 3px rgb(45, 46, 82, 0.4);
            text-shadow: 1px -1px 3px rgb(45, 46, 82, 0.4);
        }
        .spasi{height: 150px; width: 100%;}
        .gambar{width: 20%; height: 10%;}
        .card{background-color: rgba(211, 175, 187, 0.25); text-shadow: 1px 1px 4px black;}

    </style>
</head>

<body background={{ asset('img/373976.jpg') }}>
    <nav class="navbar navbar-expand-sm navbar-light"  style="text-shadow: 1px 1px 2px rgba(96, 97, 142);">
        <a class="navbar-brand text-white" href="/home"><img src={{ asset('img/logob.png') }} class="logo mx-1">HIDDEN GEM YOGYA</a>
    ...
    <div class="Judul fw-bold fs-3">Kuliner Untukmu</div> <div class="spasi"></div>
        ...
        <div class="row ms-auto">
          @foreach($kuliner as $kuliners)
            <div class="col-md-3 col-sm-4 col-lg-4 mb-4">
                <div class="card">
                    <a href="{{route('kulinerdetail',[$kuliners->id])}}" style="text-align: center;"><img src={{ asset('img/luwengsampang.jpg') }} class="formatgambar card-img-top"></a>
                    <a href="{{route('kulinerdetail',[$kuliners->id])}}" class="text-decoration-none">
                    <div class="card-body pt-2 text-light">
                        <div class="card-title"><h4>{{$kuliners->nama}}</h4></div>
                        {{$kuliners->alamat}}
                    </div></a>
                </div>
            </div>
    ...
    <footer class="text-center text-light bg-opacity-50" style="text-shadow:1px 1px 2px black;background:rgba(0,0,0, 0.5);" width="100%">
        ...
        <div class="fontt text-center p-1 " style="background-color: rgba(0,0,0, 0.5); text-shadow: 2px 2px 3px black;">
          © 2022 Copyright:
